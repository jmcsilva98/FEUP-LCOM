#ifndef BITMAP_H
#define BITMAP_H
#define BUBBLES_BACK_1 0x2c
#define BUBBLES_BACK_2 0x3

/** @defgroup bitmap bitmap
* @{
* 	The code used in this module was made by former student Henrique Ferrolho.
...
/**
 * @brief Draws an unscaled, unrotated bitmap at the given position and ignores its background color
 *
